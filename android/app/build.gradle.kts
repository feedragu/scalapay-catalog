...
// key.properties.example). Without it the release build type falls back to the
...
android {
    namespace = "com.scalapay.scalapay_catalog"
    ...
    defaultConfig {
        applicationId = "com.scalapay.scalapay_catalog"
